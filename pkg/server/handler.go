...
func NewConnectionHandler(conn protocol.Connection, rt *runtime.Runtime, reg *procedure.Registry, logger *log.Logger, logQueries bool) *ConnectionHandler {
	return NewConnectionHandlerWithTenant(conn, rt, reg, logger, "", logQueries)
}
