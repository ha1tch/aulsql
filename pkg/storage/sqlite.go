...
// createSystemCatalogViews creates SQLite views that emulate SQL Server system catalog views.
// This allows complex queries with JOINs against sys.* tables to work.
